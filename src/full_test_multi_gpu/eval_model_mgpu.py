...
def run_testing(test_filenames, batch_size, n_classes, delay_time, n_epochs=1, cpu=True, gpu=0):
    ...
    with tf.Graph().as_default() as g:
        ...
        with tf.device('/cpu:0'):
            ...
            with tf.name_scope('input_pipe'):
                images, labels, _ = rd.input_pipline(test_filenames, batch_size=batch_size, numb_pre_threads=4,
                                                 num_epochs=2 * n_epochs + 1, output_type='train')
...
if __name__ == '__main__':
    ...
    n_epochs = 200
    delay_time = 0
    run_testing(FILE_NAMES, batch_size, n_classes, delay_time, n_epochs)