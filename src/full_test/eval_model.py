...
def run_training(train_filenames, batch_size, n_classes, n_epochs=1):
    ...
    with tf.Graph().as_default() as g:
        ...
        with tf.device('/cpu:0'):
            ...
            # Restore variables, also in the CIFAR-10 they use tf.train.get_checkpoint_state() to do ... which seems to
            # return the last check point
            #print(saver.recover_last_checkpoints('summaries/chk_pt/'))
